...
**最後更新：** 2026-08-11（正式部署：Postgres／R2／Vercel）  
**網域：** https://6w7.link  
**品牌英文：** 6w7  
**品牌中文：** 樂玩ㄑ  
...
**6w7（樂玩ㄑ）** 是把好玩、好用的小工具收成一個連結入口的平台。第一版先專注「產生專屬短連結 → 社群分享 → 收匿名留言」；其他工具等真正上線再對外露出。

### 1.2 品牌語氣

- 年輕、有梗、好記；中文名「樂玩ㄑ」可與正式名「6w7」並用。
- 對外寫法建議：`6w7（樂玩ㄑ）`。
- 「樂玩ㄑ」：樂＝開心、玩＝好玩；ㄑ為注音符號，呼應英文裡的 w／七（q）的俏皮寫法，念法接近「樂玩七」。
- 不要做成陰暗、獵奇、鼓吹傷害他人的調性。
...
| 決策 | 選擇 | 原因 |
|------|------|------|
| 品牌 | 6w7／樂玩ㄑ | 與網域 6w7.link 一致，好記有梗 |
