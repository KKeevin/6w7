        ...
        <article className={`${SHELL_CONTENT} w-full`}>
          ...
          <div className="mt-8 space-y-6 text-[var(--muted)] leading-relaxed">
            <p>
              ...
              Email、你建立的連結設定，以及訪客留言內容。註冊不必填信箱；若你之後綁定並完成驗證，我們會用來寄忘記密碼重設信，以及「有新匿名留言」的通知（寄件者顯示{" "}
              {BRAND.contactEmail}
              ）。新留言通知只告訴你去網站收件匣查看，不會把留言全文放進信裡。
            </p>
            <p>
            ...
            <p>
              ...
              AdSense）提供的廣告，包括關於我們、聯絡我們、隱私權政策、服務條款、公開留言頁、示範帳號，以及登入後附說明的短網址與收件匣。登入、註冊、忘記密碼、重設密碼、驗證信箱、帳號設定與錯誤頁不會放送廣告。廣告夥伴可能使用
              Cookie
